...
advancement grant @a[advancements={custom/unlock_music=true,custom/unlock_hat=true,custom/unlock_suit=true,custom/unlock_prefix=true,completionist/completionist=false}] only minecraft:completionist/completionist