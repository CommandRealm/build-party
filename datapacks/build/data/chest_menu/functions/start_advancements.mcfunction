...
item replace entity @s[advancements={game:custom/unlock_prefix=true}] enderchest.10 with name_tag{echest: 1, HideFlags: 63, display: {Name: '[{"text":"Exclusive Prefix","color":"dark_green","italic":false}]', Lore: ['[{"text":"Unlocked","color":"gold","italic":false}]']}}
...
item replace entity @s[advancements={game:custom/unlock_hat=true}] enderchest.12 with red_stained_glass{echest: 1, HideFlags: 63, display: {Name: '[{"text":"Exclusive Hat","color":"#ff000c","italic":false}]', Lore: ['[{"text":"Unlocked","color":"gold","italic":false}]']}}
...
item replace entity @s[advancements={game:custom/unlock_music=true}] enderchest.14 with music_disc_pigstep{echest: 1, HideFlags: 63, display: {Name: '[{"text":"Exclusive Music Track","color":"#522929","italic":false}]', Lore: ['[{"text":"Unlocked","color":"gold","italic":false}]']}}
...
item replace entity @s[advancements={game:custom/unlock_sound=true}] enderchest.16 with dragon_breath{echest: 1, HideFlags: 63, display: {Name: '[{"text":"Exclusive Correct Guess Sound","color":"dark_gray","italic":false}]', Lore: ['[{"text":"Unlocked","color":"gold","italic":false}]']}}
