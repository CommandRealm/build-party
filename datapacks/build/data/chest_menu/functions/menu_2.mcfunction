...
execute store result score @s click_0 run clear @s amethyst_shard{echest:1,HideFlags:63}
execute if entity @s[scores={click_0=1..}] run function chest_menu:start_sounds