...
execute if score $number limited_guesses matches 0 run setblock -3 73 65 dark_oak_wall_sign[facing=north]{Text1:'{"text":"Guesses per","color":"blue","bold":true,"clickEvent":{"action":"run_command","value":"/execute if score $game state matches 1.. run function options:error"}}',Text2:'{"text":"build:","color":"blue","bold":true}',Text3:'{"text":"Infinite","color":"red"}',Text4:'{"text":"<<<         >>>","color":"gold","bold":true,"clickEvent":{"action":"run_command","value":"/execute as @s at @s anchored eyes if score $game state matches 0 run function options:click_guesses"}}'}
execute if score $number limited_guesses matches 1.. run setblock -3 73 65 dark_oak_wall_sign[facing=north]{Text1:'{"text":"Guesses per","color":"blue","bold":true,"clickEvent":{"action":"run_command","value":"/execute if score $game state matches 1.. run function options:error"}}',Text2:'{"text":"build:","color":"blue","bold":true}',Text3:'{"score":{"objective":"limited_guesses","name":"$number"},"color":"green"}',Text4:'{"text":"<<<         >>>","color":"gold","bold":true,"clickEvent":{"action":"run_command","value":"/execute as @s at @s anchored eyes if score $game state matches 0 run function options:click_guesses"}}'}
