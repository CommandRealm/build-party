...
execute if score $number mode matches 0 run setblock 1 73 64 bamboo_wall_sign[facing=north]{front_text:{messages:['{"text":"","color":"blue","bold":true,"clickEvent":{"action":"run_command","value":"/execute if score $game state matches 1.. run function options:error"}}', '{"text":"Mode:","color":"#ff000c","bold":true}', '{"text":"Guess","color":"yellow"}', '{"text":"<<<         >>>","color":"gold","bold":true,"clickEvent":{"action":"run_command","value":"/execute as @s at @s anchored eyes if score $game state matches 0 run function options:click_mode"}}']}}
execute if score $number mode matches 1 run setblock 1 73 64 bamboo_wall_sign[facing=north]{front_text:{messages:['{"text":"","color":"blue","bold":true,"clickEvent":{"action":"run_command","value":"/execute if score $game state matches 1.. run function options:error"}}', '{"text":"Mode:","color":"#ff000c","bold":true}', '{"text":"Versus","color":"#0006ff"}', '{"text":"<<<         >>>","color":"gold","bold":true,"clickEvent":{"action":"run_command","value":"/execute as @s at @s anchored eyes if score $game state matches 0 run function options:click_mode"}}']}}
