...
execute unless entity @s[tag=unlock_s_1,tag=unlock_s_2,tag=unlock_s_3,tag=unlock_s_4,tag=unlock_s_5,tag=unlock_s_9,tag=unlock_s_10,tag=unlock_s_11] run summon area_effect_cloud 0 10 0 {Duration:1,Tags:["randomization","randomization_c"]}
execute unless entity @s[tag=unlock_s_1,tag=unlock_s_2,tag=unlock_s_3,tag=unlock_s_4,tag=unlock_s_5,tag=unlock_s_9,tag=unlock_s_10,tag=unlock_s_11] run summon area_effect_cloud 0 10 0 {Duration:1,Tags:["randomization","randomization_c"]}
execute unless entity @s[tag=unlock_s_1,tag=unlock_s_2,tag=unlock_s_3,tag=unlock_s_4,tag=unlock_s_5,tag=unlock_s_9,tag=unlock_s_10,tag=unlock_s_11] run summon area_effect_cloud 0 10 0 {Duration:1,Tags:["randomization","randomization_c"]}
execute unless entity @s[tag=unlock_s_1,tag=unlock_s_2,tag=unlock_s_3,tag=unlock_s_4,tag=unlock_s_5,tag=unlock_s_9,tag=unlock_s_10,tag=unlock_s_11] run summon area_effect_cloud 0 10 0 {Duration:1,Tags:["randomization","randomization_c"]}
execute unless entity @s[tag=unlock_s_1,tag=unlock_s_2,tag=unlock_s_3,tag=unlock_s_4,tag=unlock_s_5,tag=unlock_s_9,tag=unlock_s_10,tag=unlock_s_11] run summon area_effect_cloud 0 10 0 {Duration:1,Tags:["randomization","randomization_c"]}
