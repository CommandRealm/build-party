...
##R -120, 40, x L x, -50, 0
item replace entity @e[tag=pl] armor.feet with leather_boots{display: {color: 0}}
item replace entity @e[tag=pl] armor.chest with leather_chestplate{display: {color: 65514}}
