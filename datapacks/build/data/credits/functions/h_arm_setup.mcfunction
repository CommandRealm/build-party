kill @e[tag=hippeh]
summon minecraft:armor_stand 1.75 74.5 69 {Tags:["credits","hippeh","show_details"],NoBasePlate:1,ShowArms:1,Rotation:[225.0f,0.0f],NoGravity:1,ArmorItems:[{},{},{},{id:"minecraft:player_head",Count:1b,tag:{SkullOwner:"HippehWizard"}}],Pose:{RightArm:[0.0f,0.0f,0.0f],RightLeg:[0.0f,0.0f,0.0f],LeftArm:[0.0f,0.0f,0.0f],LeftLeg:[0.0f,0.0f,0.0f],Head:[0.0f,0.0f,0.0f],Body:[0.0f,0.0f,0.0f]},Marker:1}
...
replaceitem entity @e[tag=hippeh] armor.feet leather_boots{display:{color:0}}
replaceitem entity @e[tag=hippeh] armor.chest leather_chestplate{display:{color:16711692}}
replaceitem entity @e[tag=hippeh] armor.legs netherite_leggings