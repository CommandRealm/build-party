...
title @a[tag=!building,scores={ready=1}] subtitle [{"text":"till the game begins . . .","color":"blue"},{"text":" (","color":"gray"},{"score":{"objective":"players_ready","name":"$number"},"color":"gray"},{"text":"/","color":"gray"},{"score":{"objective":"players_on","name":"$number"},"color":"gray"},{"text":")","color":"gray"}]
