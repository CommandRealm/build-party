...
execute as @a[scores={fake_points=0},team=blue] run advancement grant @a[tag=playing,team=blue] only advancements:custom/win_teams
execute as @a[scores={fake_points=0},team=orange] run advancement grant @a[tag=playing,team=orange] only advancements:custom/win_teams
execute as @a[scores={fake_points=0},team=green] run advancement grant @a[tag=playing,team=green] only advancements:custom/win_teams
execute as @a[scores={fake_points=0},team=pink] run advancement grant @a[tag=playing,team=pink] only advancements:custom/win_teams
execute as @a[scores={fake_points=0},team=gray] run advancement grant @a[tag=playing,team=gray] only advancements:custom/win_teams
