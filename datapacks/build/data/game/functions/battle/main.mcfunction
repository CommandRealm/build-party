...
execute as @a[tag=builder,gamemode=creative] unless entity @s[nbt={Inventory:[{Slot:8b,id:"minecraft:written_book",tag:{display:{Name:'{"bold":true,"italic":false,"color":"aqua","text":"Options Book"}'}}}]}] run function game:get_o_book
