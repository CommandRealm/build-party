title @a[tag=builder,tag=playing] actionbar [{"text":"Theme: ","color":"gold","bold":true},{"nbt":"Theme","storage":"minecraft:theme","interpret":true,"color":"yellow","bold":false}]
title @a[gamemode=spectator,x=0,y=66,z=0,distance=500..] actionbar [{"text":"Theme: ","color":"gold","bold":true},{"nbt":"Theme","storage":"minecraft:theme","interpret":true,"color":"yellow","bold":false}]
