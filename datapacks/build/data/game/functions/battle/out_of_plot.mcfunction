...
execute at @s at @e[tag=sponsor_marker,type=area_effect_cloud,sort=nearest,limit=1] run fill ~26 ~-1 ~-2 ~26 110 ~26 barrier
execute at @s at @e[tag=sponsor_marker,type=area_effect_cloud,sort=nearest,limit=1] run fill ~-2 ~-1 ~26 ~26 110 ~26 barrier