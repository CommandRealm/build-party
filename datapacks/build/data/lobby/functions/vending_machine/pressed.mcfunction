...
execute if score $rand vending_machine matches 10 run give @p potion{no_echest:1,HideFlags:63,display:{Name:'{"text":"Energy Drink","italic":false,"color":"dark_blue"}'},vending_machine:2,CustomPotionColor:2714506,CustomPotionEffects:[{Id:1,Amplifier:2,ShowIcon:1b,ShowParticles:1b,Duration:300}]}
...
advancement grant @p only minecraft:custom/use_vending_machine
